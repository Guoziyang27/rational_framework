...
Finally, we generate the behavioral agents' response by the posterior predictive distribution of the model and calculate a discrete version of distributions (since the space of response lies in discrete numbers of minutes). We also generate the quantile intervals of $60\%$, $85\%$, and $99\%$ to show in textual visualization conditions.
