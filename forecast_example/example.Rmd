...
margin = qt(0.975, df = n_size - 1) * sd(low_temp) / sqrt(n_size)
...
We then draw the payoff of decisions under different possibility of freezing, where the upper segments represent the rational agent with posterior information's payoff and the lower parts are the theoretical lowerbound of decision's payoff.
